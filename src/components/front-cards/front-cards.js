...
<div className="feat bg-gray pt-5 pb-5">
  <div className="container">
    <div className="row">
      <div className="about-top section-head col-sm-12">
        <h4><span>Want to</span> Participate ?</h4>
        <p>If your school would like to sign up for the mass health scholarships from one of the best, fastest growing healthcare platform, VisudhAjivam, let us know by simply clicking the button below! We would love to help you realise your dreams. We are just as excited!</p>
      </div>
      ...
      <div className="col-lg-4 col-sm-6">
        <div className="item"> <span className="icon feature_box_col_four"><i className="fa fa-hourglass-half"></i></span>
          <h1>Our Values</h1>
          <p>VISUDH AJIVAM PVT LTD is one of the best digital platform for health care services integrated with pharmacies, doctors, labtests, diagnosis centres India world class facilities to individuals across the country.</p>
        </div>
      </div>
